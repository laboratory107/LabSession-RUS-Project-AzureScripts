...
call az sql server firewall-rule create --resource-group %resoruceGroup% --server %server% --name AllowAllAzureIPs --start-ip-address %startIp% --end-ip-address %endIp%
